...
/**
 * Requires: c is an uppercase alphanumeric charcater.
 * Modifies: Nothing.
...
/**
 * Requires: key and original consists of only alphanumerical letters.
 *           The characters in original must be all uppercase.
